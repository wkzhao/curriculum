					...
					<div class="col-md-12">
						<div class="lrform">
							...
							<div class="form">
								...
								action="user-register" method="post" enctype="application/x-www-form-urlencoded">
									<!-- Name -->
									...
									<input type="hidden" name="rooleId" value="1" id="register-roleId">
									<!-- Checkbox -->
