									  ...
									  <div class="modal-dialog">
									    <div class="modal-content">
									    	<div class="modal-header">
										        ...
										        <h6 class="modal-title">选择想要练习的知识点</h6>
										     </div>
										     		...
										     		<c:forEach items="${knowledgePointList}" var="item">
										     			<li>
										     				<div class="knowledge-title">
										     					<i class="fa fa-chevron-up"> </i><i class="fa fa-chevron-down" style="display:none;"> </i>  <span class="knowledge-title-name">${item.name}</span>
										     				</div>
										     				<ul class="question-list-knowledge" style="display:none;">
										     						<li>
										     							<a href="student/practice-improve/${item.id}" class="btn btn-success btn-sm join-practice-btn">参加练习</a>
										     						</li>
										     				</ul>
										     			</li>
										     		</c:forEach>
									...
									<div class="modal fade incorrect-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
									  <div class="modal-dialog">
									    <div class="modal-content">
									    	<div class="modal-header">
										        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										        <h6 class="modal-title">错题练习</h6>
										     </div>
										     <div class="modal-body">
										     	<ul>
										     		<c:forEach items="${knowledgePointList }" var="item" >
										     			<li><span class="point-name"> ${item.name }</span>
															<a href="student/practice-incorrect/${item.id}"  class="btn btn-success btn-sm join-practice-btn">参加练习</a>
										     			</li>
										     		</c:forEach>
									...
									<div class="modal fade practice-exampaper-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
									  <div class="modal-dialog">
									    <div class="modal-content">
									    	<div class="modal-header">
										        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										        <h6 class="modal-title" >选择试卷，参加考试</h6>
										     </div>
										     <div class="modal-body">
										     	<ul>
