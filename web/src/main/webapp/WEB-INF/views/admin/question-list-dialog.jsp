...
<html>
	...
	<body>
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div class="page-content row">
							...
							<div id="question-list/0-0-0-0-1">
								...
								<table class="table-striped table">
									...
									<c:forEach items="${questionList }" var="items">
										<tr>
											...
											<td>${items.questionTypeName }</td><td>${items.points }</td>
											<td style="width:50px;">
		...
		<script type="text/javascript" src="resources/js/question-list/dialog.js"></script>
	</body>
</html>
