								...
								<ul id="exampaper-body">
									...
									<c:forEach items="${questionList}" var="item">
										<form class="question-body" name ="${item.questionTypeId}">
											<span class ="practice-improve " style="display: none">${item.id}</span>
											<span class ="practice-improve-points " style="display: none">${item.points}</span>
									...
									<div class="answer-desc">
										<div class="answer-desc-summary">
											<span>正确答案：</span><span class="answer_value"></span><br>
										</div>
