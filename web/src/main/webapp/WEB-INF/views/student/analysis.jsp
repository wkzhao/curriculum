					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							...
							<div id="question-list">
								<c:forEach items="${analysisList}" var="item">
								<table class="table-striped table">
									<thead>
										...
										<tr>
											<td>总题目数</td><td>做对题目</td><td>做错题目</td>
										</tr>
									</thead>
									<tbody>
											<tr>
												<td><span class="span-info">${item.totalNums }</span> </td>
												<td><span class="span-success">${item.rightTimes }</span></td>
												<td><span class="span-danger">${item.wrongTimes }</span> </td>
											</tr>
									</tbody>
									<tfoot></tfoot>
								</table>
